...
const CountBox = ({ title, value }) => {
  return (
    <div data-atropos-offset="0" className="flex mobile:gap-1 tablet-s:flex-col tablet:flex-col mobile-l:flex-col items-center mobile:w-[100%] sm:w-[100%] md:w-[100%] w-[50%] last:w-[100%]">
      <h4 data-atropos-offset="0.5" className="mobile3:flex-[100%] mobile:flex-[25%] text-[#1DC071] font-epilogue font-bold text-[26px] sm:text-[30px] text-white sm:p-3 bg-[#1c1c24] rounded-t-2xl mobile:rounded-lg w-full text-center truncate">{value}</h4>
